...
wget https://copr.fedorainfracloud.org/coprs/solopasha/hyprland/repo/fedora-$(rpm -E %fedora)/solopasha-hyprland-fedora-$(rpm -E %fedora).repo -O /etc/yum.repos.d/_copr_solopasha_hyprland.repo
